...
from splayers import similarcms,similarcbs,similarams,similarwing
...
positions = st.selectbox(label='Select position',options = ['Central Defenders','Central Midfielders','Wingers','Attacking Midfielders'])
